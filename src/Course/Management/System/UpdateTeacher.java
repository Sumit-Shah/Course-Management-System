...
public class UpdateTeacher extends JFrame implements ActionListener{
    ...
    UpdateTeacher() {
        ...
        JLabel lablecitizen = new JLabel();
        lablecitizen.setBounds(600, 350, 150, 30);
        lablecitizen.setFont(new Font("Tahoma", Font.PLAIN, 18));
        add(lablecitizen);
            ...
            public void itemStateChanged(ItemEvent ie) {
                try {
                    ...
                    while(rs.next()) {
                        ...
                        labelx.setText(rs.getString("class_x"));
                        labelxii.setText(rs.getString("class_xii"));
                        lablecitizen.setText(rs.getString("citizen"));
                        labelEmpId.setText(rs.getString("empId"));
                        tfcourse.setText(rs.getString("education"));
                        tfbranch.setText(rs.getString("department"));
                    }
